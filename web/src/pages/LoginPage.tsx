...
const cardVar = {
  ...
  visible: { opacity: 1, y: -28, x: -80, scale: 1,
...
export default function LoginPage() {
  ...
  return (
    <div className="relative overflow-hidden" style={{ minHeight: '100vh', background: '#020d1f' }}>
      ...
      <div className="relative z-10 flex flex-col" style={{ minHeight: '100vh' }}>
        ...
        {/* top bar */}
        <motion.div className="flex items-center px-10 py-6 flex-shrink-0"
        ...
        {/* ── main two-column area — takes all remaining height ── */}
            ...
            <div className="max-w-[500px] w-full" style={{ transform: 'translateY(-56px)' }}>
              ...
              <motion.div className="mb-6"
                ...
                <div className="flex items-baseline gap-x-2 flex-wrap">
                  <motion.span variants={titleWord}
                    className="text-xl text-white/35 font-medium">and</motion.span>
                  {['Grow', 'together'].map((w, i) => (
                    <motion.span key={i} variants={titleWord}
              ...
              <motion.div variants={taglineVar} initial={init} animate="visible">
                <p className="text-white/65 text-base font-medium leading-relaxed mb-1">
                  Where curious minds find each other.
                </p>
                <p className="text-white/30 text-sm">
                  Peer-to-peer learning, anywhere in the world.
                </p>
              </motion.div>
            </div>
          </div>

          {/* RIGHT 45 % — glass card, vertically centred */}
              ...
              <div className="rounded-2xl overflow-hidden"
                ...
                <div className="p-8">
                  <motion.div variants={formVar} initial={init} animate="visible">
                    ...
                    {/* heading */}
                    <motion.div variants={fv} className="mb-6">
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                      ...
                      <motion.div variants={fv} className="mb-4">
                        ...
                        <input
                          ...
                          autoComplete="email"
                          className={`w-full px-4 py-2.5 rounded-xl text-sm font-medium outline-none transition-all duration-200 glass-input${emailErr ? ' glass-input-error' : ''}${shake ? ' input-shake' : ''}`}
                        />
                      </motion.div>

                      {/* password */}
                      <motion.div variants={fv} className="mb-1">
                        <label className="block text-xs font-semibold text-white/50 uppercase tracking-wider mb-2">
                          Password
                        </label>
                        <div className="relative">
                          <input
                            ...
                            className={`w-full px-4 py-2.5 pr-11 rounded-xl text-sm font-medium outline-none transition-all duration-200 glass-input${passwordErr ? ' glass-input-error' : ''}${shake ? ' input-shake' : ''}`}
                          />
                          <button
                            type="button"
                          ...
                          >
                            {showPass ? (
                              <svg xmlns="http://www.w3.org/2000/svg" className="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{width:'18px',height:'18px'}}>
                      ...
                      {/* forgot */}
                      <motion.div variants={fv} className="flex justify-end mt-2 mb-5">
                        <button type="button"
                      ...
                      <motion.div variants={fv}>
                        <button type="submit" disabled={loading}
                          className="w-full py-3 px-4 rounded-xl text-sm font-semibold text-white transition-all duration-150 active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed"
                          style={{
                      ...
                      {/* OR divider */}
                      <motion.div variants={fv} className="flex items-center gap-3 mt-5 mb-4">
